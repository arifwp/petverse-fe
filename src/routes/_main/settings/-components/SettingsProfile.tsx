...
export const SettingsProfile = () => {
  return (
    <div className="w-full p-4 gap-4 bg-white dark:bg-neutral-900 rounded-xl flex flex-col">
      <div className="w-full gap-4 flex items-center">
        ...
        <div className="gap-0 flex flex-col">
          <h1>Arif Wahyu Prasetyo</h1>

          <h2 className="text-xs lg:text-sm">@arifwahyu</h2>
        </div>
      </div>
    </div>
  )
